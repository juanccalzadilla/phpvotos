...
<body class="bg-danger">
    <div class="bg-white w-50 mx-auto my-5 p-4">
        <form class="" id="form-sign">
            ...
            <input type="password" class="form-control m-auto" id="pass1" placeholder="Password">
            <button type="submit" class=" btn btn-dark w-100 my-3" id="btn-crear">Sign up</button>
